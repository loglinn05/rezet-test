            ...
            <nav class = "navbar navbar-expand-lg navbar-dark fixed-top  scrolling-navbar ">
                <div class = "container">
                    <a class = "navbar-brand font-weight-bold" href="#" data-toggle = "modal" data-target="#modalPush">
                        ...
                        <strong style = "color:#000; text-shadow:2px 2px 3px #fff;">&nbsp; Test</strong>
                    </a>
                    ...
                    <div class = "container">
                        <div class = "row mt-5">
                            <div class = "col-md-12 mb-4 white-text text-center">
                                <h1 class = "h1-reponsive white-text text-uppercase font-weight-bold mb-0 pt-md-5 pt-5 wow fadeInDown" data-wow-delay = "0.3s"><strong>T E S T</strong></h1>
                                <hr class = "hr-light my-4 wow fadeInDown" data-wow-delay = "0.4s">
                                <h5 class = "text-uppercase mb-4 white-text wow fadeInDown" data-wow-delay = "0.4s">
                                    <strong>R E Z E T</strong>
                                </h5>                                
                                <a class = "btn btn-outline-white wow fadeInDown" href = "index.php" data-wow-delay = "0.4s">PHP code</a>
                                <a class = "btn btn-outline-white wow fadeInDown" href = "js_code.php" data-wow-delay = "0.4s">JS code</a>
                            </div>                            
                        </div>
                    </div>
                </div>
